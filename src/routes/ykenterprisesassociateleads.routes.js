...
import {
  ...
  YkEnterprisesAssociatesAllLeads,
  revertLeadToNew, 
  changeLeadStageByIpqsHead,
  // 📝 CHANGED: Function name updated
  assignLeadToYkEnterprisesAssociateEmployee,
  // 📝 CHANGED: Function name updated
  getYkEnterprisesAssociatesVisitDetails,
  getAllLeadsForIpqsHead,
  // 📝 CHANGED: Function name updated
  getHotYkEnterprisesAssociateLeads,
  // 📝 CHANGED: Function name updated
  getYkEnterprisesAssociatesEmployeesRevenue,
  getNewAssignedLeadsSummary,
  getSalesFunnel,
  // 📝 CHANGED: Function name updated
  getUnscheduledYkEnterprisesAssociateLeads,
  // 📝 CHANGED: Function name updated
  getScheduledYkEnterprisesAssociateVisits,
  // 📝 CHANGED: Function name updated
  updateYkEnterprisesAssociateVisitStatus,
  // 📝 CHANGED: Function name updated
  rescheduleYkEnterprisesAssociateVisits,
  // 📝 CHANGED: Function name updated
  getCompletedYkEnterprisesAssociateVisits,
  // 📝 CHANGED: Function name updated
  YkEnterprisesAssociateTeamTodaysVisits
// 📝 CHANGED: Import path updated to the YK Enterprises controller
} from "../controllers/ykenterprisesassociateleads.controller.js";
...
router.post(
  ...
  requireRole(["Y-K-Enterprises-Associates-Head", "Y-K-Enterprises-Associates-Employee", "IpqsHead"]), 
...
router.get(
  ...
  "/ykenterprisesassociates/all-leads",
  requireAuth,
  // 📝 CHANGED: Allowed roles updated
  requireRole(["Y-K-Enterprises-Associates-Head", "IpqsHead"]),
  // 📝 CHANGED: Function name updated
  YkEnterprisesAssociatesAllLeads
);
...
router.patch(
  ...
  requireAuth,
  // 📝 CHANGED: Allowed roles updated
  requireRole(["IpqsHead", "Y-K-Enterprises-Associates-Head", "Y-K-Enterprises-Associates-Employee"]),
  changeLeadStageByIpqsHead
);
...
router.get(
  // 📝 CHANGED: Route URL updated
  "/ykenterprisesassociates/visit-details",
  requireAuth,
  // 📝 CHANGED: Allowed roles updated
  requireRole(["Y-K-Enterprises-Associates-Head"]),
  // 📝 CHANGED: Function name updated
  getYkEnterprisesAssociatesVisitDetails
);
...
router.get(
  // 📝 CHANGED: Route URL updated
  "/ykenterprisesassociates/todays-all-visits",
  requireAuth,
  // 📝 CHANGED: Allowed roles updated
  requireRole(["Y-K-Enterprises-Associates-Head", "IpqsHead"]),
  // 📝 CHANGED: Function name updated
